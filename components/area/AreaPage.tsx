...
/* ★ 2026-08-31 — 지역 안내 쪽에는 광고주 담당자 연락처 카드가 실린다.
   광고를 실어 놓고 관계 고지가 없으면 신고에 그대로 걸린다(설계도 4장). */
const 관계고지문구 = [
  "이 페이지에는 업소 담당자의 광고가 함께 실려 있습니다. 그 밖의 내용은 공개 자료를 정리한 것입니다.",
  "담당자 연락처가 실린 부분은 광고입니다. 나머지는 공개된 자료를 모아 적었습니다.",
  "아래 연락처 안내는 광고로 실린 것이며, 다른 내용은 공개 자료 기준입니다.",
  "업소 담당자 광고가 이 쪽에 포함되어 있습니다. 그 밖은 공개 자료를 정리했습니다.",
    ...
    <>
      ...
      {isA && area.contact ? (
        ...
        <div className="callbar" role="complementary" aria-label="광고 제휴 문의">
          <span>
            {문의앞말고르기(area.slug)} <b>{AD_KAKAO}</b>
          </span>
        </div>
      )}
    </>
