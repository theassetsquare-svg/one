...
export default function SEO({
  ...
  return (
    <Head>
      ...
      <meta
        name="keywords"
        content="대전원나이트, 대전 원나이트, 대전나이트, 대전 나이트, 대전 나이트클럽, 대전 38세 이상 나이트, 대전원나이트 후기, 대전원나이트 예약, 대전 클럽"
        key="kw"
      />
      <meta name="google-site-verification" content="HJjm7MRxykCQ7d_9L7glaTeeaWrmJIzAKY0BcNcfm88" key="gsv" />
      <meta name="naver-site-verification" content="851531b84b2d72bbbd53ca8ec7df480ca4f368b2" key="nsv" />
      ...
      <link rel="alternate" type="application/rss+xml" title="대전원나이트 RSS" href={`${SITE}/rss.xml`} key="rss" />
      ...
      <meta name="author" content="대전원나이트" key="author" />
      <meta name="publisher" content="대전원나이트" key="pub" />
      ...
      <meta property="og:site_name" content="대전원나이트" key="og:site" />
      ...
      <meta property="og:image:alt" content="대전원나이트 - 38세 이상 + 여성 손님 2가지 혜택" key="og:alt" />
