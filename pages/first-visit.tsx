...
export default function FirstVisit() {
  return (
    <>
      <SEO
        title="대전원나이트 까치 첫 방문 6단계 가이드 — 입장·드레스코드·예약"
        description="처음 들르시는 분께 필요한 6단계. 38세 이상 신분증, 22시 전 여성 차비 3만원, 드레스코드, 주차, 결제까지 한 번에 정리했습니다. 도착 전 010-3918-9414 전화 권장."
        path="/first-visit"
        ogImage="https://one-5ei.pages.dev/og/first-visit.png"
        ogTitle="대전원나이트 까치 첫 방문 6단계 가이드"
        ogDesc="38세+ 처음 가시는 분께 까치가 안내."
      />
        ...
        <div className="container">
          ...
          <section aria-labelledby="fv-h">
            ...
            <div className="bento">
              ...
              <div className="bic">
                <h3>④ 예약</h3>
                <p>까치 010-3918-9414 전화 예약 권장. 당일 가능.</p>
              </div>
              <div className="bic">
                <h3>⑤ 주차</h3>
