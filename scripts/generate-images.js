...
// 1:1 Search thumbnail 1080x1080 — 대전원나이트 까치 풀버전 (이모지 없는 깔끔한 디자인)
...
<text x="540" y="115" font-family="Noto Sans KR" font-size="86" font-weight="900" fill="#FFD700" text-anchor="middle">대전원나이트 까치</text>
...
<text x="540" y="343" font-family="Noto Sans KR" font-size="28" font-weight="700" fill="#FFFFFF" text-anchor="middle">까치 웨이터가 직접 응대 · 신분증 필수</text>
...
<text x="540" y="910" font-family="Noto Sans KR" font-size="46" font-weight="900" fill="#FFFFFF" text-anchor="middle">까치 직통 010-3918-9414</text>
...
<text x="540" y="1052" font-family="Noto Sans KR" font-size="22" font-weight="600" fill="#2a1a00" text-anchor="middle">대전원나이트 까치 · 38세+ 안전 운영</text>
</svg>`;
...
<text x="256" y="180" font-family="Noto Sans KR" font-size="100" font-weight="900" fill="#000000" text-anchor="middle">까치</text>
...
const pages = [
  { name: 'home',        title: '대전원나이트 까치',        sub: '38세 이상 + 여성 손님 2가지 혜택',     bg1: '#FF1744', bg2: '#FFD700' },
  { name: 'event',       title: '10시 이전 여성 혜택',      sub: '차비 3만원 + 맥주 기본 서비스',         bg1: '#E91E63', bg2: '#FFD700' },
  { name: 'story',       title: '까치 이야기',              sub: '대전 나이트라이프 기준점',              bg1: '#9C27B0', bg2: '#FF6B35' },
  ...
  { name: 'contact',     title: '예약 문의',                sub: '까치 010-3918-9414 직통',               bg1: '#000000', bg2: '#FF1744' },
];
...
<text x="600" y="485" font-family="Noto Sans KR" font-size="40" font-weight="900" fill="#000000" text-anchor="middle">까치 010-3918-9414</text>
</svg>`;
