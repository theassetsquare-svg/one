 ...
 * 실행: node scripts/generate-night-og.js
 *
...
const VENUES = [
  ...
  { no: 6, slug: 'sillim-grandprix-night', lines: ['신림', '그랑프리나이트'], region: '서울 관악구 신림동', bg: '#1D5E3F', group: 'B' },
  { no: 7, slug: 'sangbong-hangukgwan-night', lines: ['상봉동', '한국관나이트'], region: '서울 중랑구 상봉동', bg: '#3D2B7A', group: 'B' },
  { no: 8, slug: 'suyu-shampoo-night', lines: ['수유', '샴푸나이트'], region: '서울 강북구 번동', bg: '#A0410D', group: 'B' },
  { no: 9, slug: 'busan-asiad-night', lines: ['부산', '아시아드나이트'], region: '부산 동래구 온천동', bg: '#0B6E6E', group: 'B' },
  { no: 10, slug: 'suwon-chance-dome-night', lines: ['수원', '찬스돔나이트'], region: '경기 수원 권선구', bg: '#5C3A00', group: 'B' },
