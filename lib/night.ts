...
export const VENUES: NightVenue[] = [
  ...
  },
  {
    ...
    ogV: '-ad0924',   // 2026-09-24 광고주 복구 — 로또 표준 4줄 카드(새 파일 이름)
    nameA: '창원룰루랄라나이트',
    nameB: '창원 룰루랄라나이트',
    nameC: '창원 나이트클럽',
    group: 'A',
    ...
    facts: [
      ...
      { label: '업종', value: '성인 나이트클럽' },
      { label: '연락처', value: '미게재(업소와 제휴 관계 없음)' },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: '이 페이지는 업소와 제휴 관계가 없어 예약을 받거나 연락처를 안내하지 않습니다. 인원과 도착 시간은 현장 직원에게 말하면 됩니다.',
      },
    ],
